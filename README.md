...
* メタデータ例：
  ...
  ```md
  - [ ] レビュー資料作成 start: 2025-09-10 10:00 due: 2025-09-10 11:00 repeat: weekly tue,thu #work
  - [ ] 出張手配 📅 2025-09-15 🛫 2025-09-15 09:00 recur: RRULE:FREQ=DAILY;INTERVAL=2
  - [ ] 朝会 start: 2025-09-11 09:00 due: 2025-09-11 09:15 scheduled: 2025-09-10
  ```
* 繰り返し（フォールバックの簡易自然言語）：
...
本プラグインは Google カレンダーへ変更（削除を含む）を行います。初回はテスト用カレンダーで検証してください。利用は自己責任でお願いします。
